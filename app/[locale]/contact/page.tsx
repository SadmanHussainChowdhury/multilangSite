              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-4 border-2 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm ${errors.name ? 'border-red-400 bg-red-50/50' : 'border-slate-200 hover:border-blue-300'
                      }`}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 border-2 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm ${errors.alien_number ? 'border-red-400 bg-red-50/50' : 'border-slate-200 hover:border-blue-300'
                        }`}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 border-2 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm ${errors.nationality ? 'border-red-400 bg-red-50/50' : 'border-slate-200 hover:border-blue-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 border-2 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm ${errors.phone ? 'border-red-400 bg-red-50/50' : 'border-slate-200 hover:border-blue-300'
                        }`}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-5 py-4 border-2 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm ${errors.visa_type ? 'border-red-400 bg-red-50/50' : 'border-slate-200 hover:border-blue-300'
                      }`}
                  >
