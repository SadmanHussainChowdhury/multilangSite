...
export default function HouseRentTaxRefundPage() {
  const t = useTranslations('houseRentTaxRefund');
...
<p class="text-lg text-gray-700 leading-relaxed">${t('details')}</p>`;
  const { pageContent, loading, isDeactivated } = usePageContent('houserenttaxrefund', t('title'), fallbackContent);
          ...
          <div className="bg-white rounded-lg shadow-md p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 bg-purple-50 rounded-lg">
                <h3 className="text-lg font-semibold text-purple-800 mb-2">{t('benefit1')}</h3>
                <p className="text-gray-600">Complete documentation support</p>
              </div>
              <div className="p-6 bg-purple-50 rounded-lg">
                <h3 className="text-lg font-semibold text-purple-800 mb-2">{t('benefit2')}</h3>
                <p className="text-gray-600">Expert tax advice and consultation</p>
              </div>
              <div className="p-6 bg-purple-50 rounded-lg">
                <h3 className="text-lg font-semibold text-purple-800 mb-2">{t('benefit3')}</h3>
                <p className="text-gray-600">Maximize all eligible deductions</p>
              </div>
              <div className="p-6 bg-purple-50 rounded-lg">
                <h3 className="text-lg font-semibold text-purple-800 mb-2">{t('benefit4')}</h3>
                <p className="text-gray-600">Dedicated support throughout</p>
              </div>
            </div>
